...
if(!file.exists("./Data/DRdata.csv")){
    # everything in here is a cbh
    allDF <- read_rds("./Data/prepared_cbh_2018_09_04_11_49_50.RDS")
    head(allDF)
    ...
    write_csv(DF, "./Data/DRdata.csv")
}

DF <- read_csv("./Data/DRdata.csv", col_types="ccdcidcddccddidcdc")
...
saveRDS(dataList, "./Data/dataList.Rds")
